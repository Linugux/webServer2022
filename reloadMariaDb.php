<p id="reloadphp" style="position: fixed; text-align: center;"></p>
<h1 id="reloadtitle" style="text-align: center;"></h1>
  <img width="15%" src="linugux.jpg" style="position:fixed; top: 5px; right: 0"/>
  Creation and Design For Linugux inx.
  	<br>
	<a id="reloadmsg"></a>
<div id="queryMaria" style="overflow-x:scroll;display:block;max-width: 1000px"><?php include 'queryMaria.php'?></div>
	<hr>
