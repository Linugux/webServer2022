...
<html>
<head>
	<title>Files Linugux</title>
	<link rel="canonical" href="https://linugux.ddns.net/fortuneCowsay.php " />
...
<body style="background-color: black; color: white;">
	<div align="Left">
		<pre>
			<tt>
				Information each post Fortune with Cowsay 	
				<a href="fortuneRecord.php"> Resume Post's</a> 
			</tt>
		</pre>
	</div>
</body>
