...
<h1 id="reloadtitle" style="text-align: center;">http://Linugux.ddns.net</h1>
  ...
  Creation and Design For Linugux inx.
  	<br>
	<a id="reloadmsg"></a>
<div id="queryMaria1" style="overflow-x:scroll;display:block;max-width: 1000px">
  <?php include 'queryMaria1.php'?></div>
	<hr>
...
<script type="text/javascript">
    ...
    $('#queryMaria1').load('queryMaria1.php');//actualizas el div
   }, 1000 );
});
    $(document).ready(function() {
      var refreshId =  setInterval( function(){
