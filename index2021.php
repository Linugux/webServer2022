...
<section style="top: 10px;" >
      <a href="comandosLinux.php">Commands Linux Terminal</a> 
    </section>
    <hr>
    <header id="header" style="position: ">
        <div class="typewriter">
            <h1 id="reloadmsg" style="text-transform: capitalize; font-size: 10px; color : black;position:relative;" ></h1>
        </div>
        <div class=''>
            <img width="9%" src="linugux.jpg" style="position: absolute;top: 5px; left: 320px;" align="left" />
            <div class="typewriter" style="position: relative;" align="center">
              <h1 id="reloadtitle" style="position: relative; background-color: black; max-width: 300px; top: 4px; font-size: 26px;"><a>Linugux.ddns.net</a></h1>
            </div>
        </div>
    </header>
    <section>
        <nav>  
            <ul class="navigation" style="position: relative; font-size: 13px;">
        ...
        <div class="home" align="left"><br>
              <p>
                  <tt>
                      <pre id="reloadcowsay" style="max-width: 36px; font-size: 13px; color: white; background-color: black;">
              ...
              <br>
              <a style="position: relative;" class="linugux" id="title" style="max-width: 100px; font-size: 22px">Creation and Design</a>
          </div>
        </nav>
    <article>
       <div class="" align="justify-content" style="font-size: 12px;">
            <tt>
  ...
  $(document).ready(function() {
    ...
    $('#cowsayMysql').load('cowsayMysql.php');//actualizas el div
   }, 1000 );
});
$(document).ready(function() {
      var refreshId =  setInterval( function(){
...
.linugux {
  ...
  background: ;
  position: relative;
  animation: mymove 16.18s infinite;
...
<section id="" class="code" style="display: none">
    <div class="" align="justify">
        <div class="typewriter">    
            <p>HomeServer = Raspberry Pi +b + SD 2GB + 5v.<br>  
    ...
    <section id="" class="about" style="display: none">
        <div class="">
        ...
        Differentiate between build variants lenguages of programmation.
            ...
            <a href="pepe.jpg"><img width="50%" src="pepe1.jpg"></a>
          </p>
        </div>
      </div>
    </section>
    ...
    <footer id="" style="display: none ;" class="contact">
                  <p style="background: black">
                      ...
                      <a href="https://wa.me/525624600477">Whatsapp ::: +52 56 2460 0477</a><br>
                      <a href="Linugux.gif"><img width="30%" src="Linugux.gif"></a>
                  </p>       
            <p style="background-color: black ; font-size:14px;">
                <a style="color: white;">Creation and Design<br>for<br>Linugux</a><br>
                <a style="color: white;">http://Linugux.ddns.net</a>
            </p>
    </footer>
    <footer>
        <div>
            <a style="color: black;">Cuautitlan Izcalli, Edo. de Méx., México.</a><br>
            <a style="color: black;">CopyLeft<a href="/pages/Imagenes/copyleft.png">
              <img width="3%" src="/pages/Imagenes/copyleft.png"></a>Linugux ||| 2022
            </a><br>
            <a style="background: black;" href="/pages/Imagenes/fs-gang.png"><img width="70%" src="/pages/Imagenes/fs-gang.png"></a>
